def Generator_File(file_in1,file_in2):
    try:
        ...
        selected_user=open('selected_user5.txt','w',encoding='utf8')
        selected_video=open('selected_videos5.txt','w',encoding='utf8')
        user_set=set()
        video_set=set()
...
if __name__=='__main__':
    Generator_File(r'F:\tencent\findtop1000\main\top_1000_user.txt',r'F:\tencent\findtop1000\main\vid3.txt')